	...
	return (
		<div className="snap-start w-screen h-screen flex flex-wrap items-center justify-center bg-purple-50">
			<div className="flex-1 text-center">
				...
				<br />
				<div className='mr-10'>
					<img className="max-w-xs rounded-full mx-auto" src={workImage} alt="Computer" />
				</div>
			</div> 
			...
			<div className="flex-1 text-center">
				...
				<div className="flex-1 text-left m-10">
					<strong>Other Experience:</strong> Medical student, teaching assistant, research assistant, 7 years in hospitality industry
				</div>
			</div> 
		</div>
