...
const Contact = () => {
	...
	return ( 
		<div className="snap-start w-screen h-screen flex flex-wrap items-center justify-center  bg-amber-50">
			
			<div className="w-full max-w-md"> 
				<div className="mb-4 text-center">	
					<h1 className="text-2xl font-bold mb-4 text-pink-800">Send me a message</h1>
				</div>
				<form className=" bg-gray-100 shadow-xl rounded px-8 pt-6 pb-8 mb-4" onSubmit={sendEmail}>
					<div className="mb-4">
